...
\rhead{ Gruppe 6}
\lhead{\textbf{Infrarot Spektroskopie} Vibrationsspektrum -  \textbf{Anhang VIII}}
\fancyheadoffset{-1cm}
...
\begin{luacode*}
  ...
  px,py = fs.readcsv("data/pzweig1cm64Scan.txt",0)
  rx,ry = fs.readcsv("data/rzweig1cm64Scan.txt",0)
  ...
  tex.sprint("\\draw[dashed] (axis cs:2143.18,0) -- (axis cs:2143.18,1.4) node [anchor=north,rotate=90,above,font=\\tiny,pos=0.9] {Q-Zweig $\\tilde{\\nu}$=2143.18 } ;")
