...
\rhead{ Gruppe 24}
\lhead{Flammen-Emissions-Spektroskopie}
...
--Instrumentelle nachweisgrenze Skript
local cn = 3 * sx0 / m
...
function messi(messwert)
  return (messwert)/10517
end
...
function drawD()
 ...
 --   tex.sprint("\\addplot[".."domain="..minx..":"..maxx..", no markers".."]{"..quad.a.."*x^2+"..quad.b.."*x+"..quad.c.."};")
  --  tex.sprint("\\addplot[".."domain="..minx..":"..maxx..", thick".."]{"..m.."*x+"..b.."};")
...
local referenz=messi(16691.73)
local trinkwasser=messi(14688.9)
local evian=messi(6632.23)
local jeden=messi(17689.73)
...
tex.print('\\par')
tex.print('Nachweisgrenze:'..string.format('%.2f',nwg)..'mg/L')
tex.print('\\par')
tex.print('Bestimmungsgrenze:'..string.format('%.2f',xbg)..'mg/L')
tex.print('\\par')
tex.print('Referenz ='..string.format('%.2f',referenz)..'mg/L')
tex.print('\\par')
tex.print('Trinkwasser ='..string.format('%.2f',trinkwasser)..'mg/L')
tex.print('\\par')
tex.print('Evian ='..string.format('%.2f',evian)..'mg/L')
tex.print('\\par')
tex.print('Jeden Tag ='..string.format('%.2f',jeden)..'mg/L')
...
\pgfplotsset{
  standard/.style={
    axis x line=middle,
    axis y line=middle,
    legend style={at={(1.4,0.9)},anchor=north},
    y label style={at={(axis description cs:-0.1,.5)},rotate=90,anchor=south},
  x   label style={at={(axis description cs:0.6,-.3)},anchor=south},
    x tick label style={at={(axis description cs:-0.1,-.5)},rotate=90,anchor=east},
  }
}
\begin{document}
\lhead{Flammen-Emissions-Spektroskopie (FES)  Gruppe 24}
\begin{figure}
\begin{tikzpicture}
  \tikzset{
  ...
  \begin{axis}[standard,xlabel=Konzentration (mg/L),ylabel=Messsignal]
    ...
    \addplot[domain=0:3] {10517*x };
    \addlegendentry{$f(x)=10517x$}
 \addplot[white,thick,domain=0:2,draw=none]{x*0};
    \addlegendentry{Korrel.}
    \addplot[white,thick,domain=0:2,draw=none]{x*0};

    \addlegendentry{$ = 0.99846$}
  \end{axis}
\end{tikzpicture}
\caption{Kalibrierlinie}
\end{figure}
\par
\tabellenwerte
\par
