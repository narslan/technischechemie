...
\rhead{ Gruppe 6}
\lhead{\textbf{Fluoreszenz} Vergleich der Anregungs- und Emissionsspektren bei pH 12}
...
\nextgroupplot[standard,title=Emissionsspektrum  360-370 \si{\nano\meter}]
    \addplotm
   % \addlegendentry{Emissionsspektrum ph 6 360-370 \si{\nano\meter}}
\nextgroupplot[standard,title=Emissionsspektrum  320-330 \si{\nano\meter}]
    \addplotn
    %    \addlegendentry{Emissionsspektrum ph 6 320-330 \si{\nano\meter}}
\nextgroupplot[standard,title=Anregungsspektrum  350-340 \si{\nano\meter}]
    \addplott
    \pgfplotsset{title style={at={(0.5,-0.4)}}}

     %\addlegendentry{Anregungsspektrum ph 6 350-340 \si{\nano\meter}}
    \nextgroupplot[standard,title=Anregungsspektrum 420-410 \si{\nano\meter}]
    \addplotu
        \pgfplotsset{title style={at={(0.5,-0.4)}}}
