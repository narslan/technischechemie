...
\lhead{Photometrie - \small{Die Kalkibrierreihe Anhang 1}}
...
\addlegendentry{$\mathsf{y=0.04402x+0.06902}$}
\addplot[domain=0:4] {0.04402*x+0.06902};
\addlegendentry{$\mathsf{R^2=0.8597}$}
\end{axis}
\end{tikzpicture}
&
\begin{tikzpicture}[font=\sffamily]
...
\addlegendentry{$\mathsf{y=0.04562x+ 0.06608}$}
\addplot[domain=0:4] {0.04562*x +0.06608};
\addlegendentry{$\mathsf{R^2=0.8696}$}
