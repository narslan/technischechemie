...
Aus der quantentheoretischen Beschreibung des harmonischen Oszillators erhält man seine Energie-Eigenwerte $E _v$:
\begin{equation}
...
In dem Versuch sollte die Bindungslänge des CO-Moleküls mit Hilfe der ermittelt werden.
