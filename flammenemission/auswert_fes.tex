...
tex.print('\\par')
tex.print('Referenz ='..string.format('%.4f',referenz)..'mg/L')
tex.print('Trinkwasser ='..string.format('%.4f',probe2)..'mg/L')
tex.print('\\par')
tex.print('Trinkwasser ='..string.format('%.4f',cn)..'mg/L')
...
\begin{tikzpicture}[scale=1.8,transform shape]
  ...
  \begin{axis}[standard,xlabel=Konzentration/(mg/L),ylabel=Messsignal]
    \addplotCHIpf
    \addplot[violet,thick,domain=0:5] {-820*x^2+12276.75*x+27.52 };
  \end{axis}
\end{tikzpicture}
\par
\tabellenwerte
