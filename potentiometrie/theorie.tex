...
\lhead{\footnotesize Potentiometrische Titration - Aufgabe 2}
...
\begin{document}
\begin{table}
  \caption{ Berechnung der theoretischen Werte einer theoretischen Titrationskurve (50 \si{\milli\liter} einer 0.025 M \ce{H2SO4}-Lösung mit 0.1 M \ce{NaOH} in 1 \si{\milli\liter} Schritten)}
