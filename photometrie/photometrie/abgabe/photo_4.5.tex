...
--- SMDE, 
for line in io.lines("photo_4-5.csv") do
...
function tabelle()
  ...
  tex.print('\\Large {\\color{skyblue1}\\textbf{Kalibrierkurve:y='..string.format('%.4f',m)..'*x+'..string.format('%.4f',vz)..'}}')
  tex.print('\\par')
...
tex.print('\\par')
tex.print('Aufgabe 4.4: Probe1='..string.format('%.4f',probe1)..'mg/L')
...
\begin{document}
\lhead{FE-Gruppe 18 \textbf{Kalibrierkurve} \footnotesize{Anatoli Schmidt, Nevroz Arslan}}
