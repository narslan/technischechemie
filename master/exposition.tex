...
that person.”\footnotemark\footnotetext{Chimamanda Ngozi Adichie, The danger of a single story, Ted Talk, 2009.} } 
\end{myenv}
...
Adichie gibt in ihrem Vortrag nun Hinweise darauf, warum sich manche
...
\textit{Introducing Cultural Studies} (Essex: Longman, 2008), 73.} Herrschaft
...
Perspective} (New York:Lang, 2012).} Die Praxis der Gegenerzählung greift das
...
Postkoloniale Theorie könnte als eine Position beschrieben werden, die  auf
...
Der Fokus auf bestimmte, einheitlich gedachte (Differenz-)Erfahrungen kann
