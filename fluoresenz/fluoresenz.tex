...
\end{tikzpicture}
\caption{Das Jablonski-Diagramm: Die thermische Variaton der Übergänge} \label{fig:jablonski}
\end{figure}
...
Experimentell wird ein pKs Wert für 2-Naphthol$^*$ 2.9 festgestellt und ein pKs Wert für 2-Naphthol 9.1.
Der ermittelte pKs Wert 9.1 von 2-Naphthol weicht jedoch von der Literaturangabe
2-Naphthol hat pKs Wert von 9.63 bei T=25 \si{\celsius} ab. ~\supercite{crc} Durch Erhöhung der Anzahl der Messungen kann
...
\begin{figure}[!htbp]
	\begin{tikzpicture}[inner sep=0pt,thick, dot/.style={fill=blue,circle,minimum size=3pt}]
		\begin{axis}[
			...
			\addplot[thick,blue,mark=x] table {
				X Y
				12.198 1.86032375e5
				9.973 1.22534625e5
				8.158  8.8750166e3
			...
			\addplot[thick,red,mark=x]  table {
				X Y
				12.198 8.50769043e2
				9.973 2.25562051e4
				8.158  1.11267211e5
			...
			\addplot[thick,yellow,mark=x]  table {
				X Y
				12.198 1.59646828e5
				9.973 1.12899375e5
				8.158  5.58971602e4
			...
			\node[coordinate,pin=right:{\tiny pH = pKs = 9.1}] at (axis cs:9.1,6.6e4) {};
			\node[coordinate,pin=right:{\tiny pH = pKs = 2.9}] at (axis cs:2.9,3.2e4) {};
			\node[dot] (a) at (axis cs:2.91,3.2e4) {};
