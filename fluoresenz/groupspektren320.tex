...
\rhead{ Gruppe 6}
\lhead{\textbf{Fluoreszenz} Emissionsspektren bei der Anregungwellenlänge $\lambda$ = 320 \si{\nano\meter} }
...
\nextgroupplot[standard,title= \textbf{ph 2}]
    \addplotc
\nextgroupplot[standard,title= \textbf{ph 4}]
    \addplote
 \nextgroupplot[standard,title=\textbf{ph 6}]
    \addplotg
  \nextgroupplot[standard,title= \textbf{ph 8} ]
    \addplotj
        \pgfplotsset{title style={at={(0.5,-0.4)}}}
  \nextgroupplot[standard,title=\textbf{ph 10} ]
    \addplotl
        \pgfplotsset{title style={at={(0.5,-0.4)}}}
