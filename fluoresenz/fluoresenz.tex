...
\subsection{Graphische Bestimmung aus $I$-$pH$-Diagrammen mittels Wendepunktanalyse}
...
\begin{figure}[!htbp]
  \begin{tikzpicture}[inner sep=0pt,thick, dot/.style={fill=blue,circle,minimum size=3pt}]
    \begin{axis}[
      ...
      \addplot[thick,green,mark=x]  table {
        X Y
        12.198 1.59646828e5
        9.973 1.12899375e5
        8.158  5.58971602e4
    ...
    \end{axis}
  \end{tikzpicture}
  \caption{Kurvenverlauf der pH-Werte gegen $I_F$ und Bestimmung der pKs-Werte}
\end{figure}
