...
Experience“\footnotemark\footnotetext{bell hooks, \textit{Teaching to
Transgress. Education as the Practice of Freedom} ( New York: Routledge, 1994).}
...
Titel „Essentially Speaking“\footnotemark\footnotetext{bell hooks, Teaching to Transgress,77.} und stellt ihm einen kritischen
...
bedient.\footnotemark\footnotetext{hooks, \textit{Teaching to Transgress}, 81.}\\
...
\begin{myenv}
  \textit{„Identity politics emerges out of the struggles of oppressed or
    ...
    struggle.“\footnotemark \footnotetext{hooks, \textit{Teaching to
    Transgress}, 88.}
    }
\end{myenv}
...
Ungleichgewicht erkannt und problematisiert werde.\footnotemark\footnotetext{Ebd., 89.}\\
...
unserer disziplinären und pädagogischen Praxen.“\footnotemark\footnotetext{Mohanty, „On Race and Voice,“ 191.}\\
...
setzen.\footnotemark\footnotetext{hooks, \textit{Teaching to Transgress}, 90.}\\
