...
von \ce{CO2} \ce{\dot{n}_{\ce{CO2}} } berechnet werden.

\subsubsection{Ermittlung von \ce{\dot{n}_{\ce{CO2}}}} % (fold)
\label{ssub:erm}
Es gilt :
\begin{equation}
...
\begin{table}[ht!]
 \begin{tabularx}{\textwidth}{XXXX}
\ce{c_{kat}}/\si{\mol\per\cubic\centi\meter} & \ce{t0} / \si{\second} & n / \si{\mol} & \ce{\dot{n}_{\ce{CO2}}}/\si{\mol\per\second}  \\
\hline
\num{0}     &    62.97 & \num{4.09e-6} & \num{64.95e-9} \\
\num{3e-6}  &   40.9 &  \num{4.09e-6}  & \num{100.0e-9} \\
\num{6e-6} &  39.11 & \num{4.09e-6}     & \num{104.5e-9} \\
\end{tabularx}
  \caption{ Ermittlung von \ce{\dot{n}_{\ce{CO2}}} }
\end{table}
...
Wird nun \ce{\dot{n}_{\ce{CO2}}^2} gegen \ce{c_{kat}} aufgetragen ergibt sich eine gerade mit Steigung \ce{\gamma}.
\begin{equation}
...
\begin{table}[ht!]
 \begin{tabularx}{\textwidth}{XXXX}
\ce{c_{kat}} [\si{\mol\per\cubic\centi\meter}] & \ce{t0} [\si{\second}]  & \ce{\dot{n}_{\ce{CO2}}}  [\si{\mol\per\second}] & \ce{\dot{n}_{\ce{CO2}}^2}  [\si{\square\mol\per\square\second}]  \\
\hline
0  & 62.97 & \num{6.495e-6} & \num{42.185e-12}  \\
\num{3.03e-7}  & 45.47 & \num{8.994e-6} & \num{80.89e-12} \\
\num{6.06e-7}  &  39.11 & \num{10.46e-6} & \num{109.4e-12} \\
...
\begin{figure}[htbp!]
      ...
      \begin{axis}[
          ...
          grid=major,
          grid style={dashed,gray!30},
          ylabel= \ce{\dot{n}_{\ce{CO2}}^2}, % Set the labels
          xlabel= \ce{c_{kat}},
          xlabel style={font=\large},
          ylabel style={font=\large},
