...
\rhead{Gruppe 24}
\lhead{\textbf{HPLC} Diskussion - Koffein-Bestimmung}
...
$\ce{c_{Kaffee}} = 875 \, \si{\milli\gram\per\liter} \pm 119  \, \si{\milli\gram\per\liter}$
 mit der  \enquote{offiziellen} ~\supercite{koffeincom} Konzentrationsangabe $\ce{c_{Kaffee}} = 800 \, \si{\milli\gram\per\liter}$ verglichen wird,
