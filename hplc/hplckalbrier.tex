...
\begin{document}
\lhead{HPLC Gruppe 18  \footnotesize{Nevroz Arslan}}
\begin{itemize}
...
\begin{tikzpicture}[scale=1.4,font=\sffamily]
  ...
  \begin{axis}[standard,xlabel=Konzentration/(mg/L),ylabel=Peakflache]
    \addplotCHIpf
  \end{axis}
\end{tikzpicture}
\par
...
\begin{equation}
  Pr_1 = \frac{\zeta \cdot c _p}{\lambda _{H_2O}}
\end{equation}
\par
