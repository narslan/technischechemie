...
\rhead{ Gruppe 6}
\lhead{\textbf{Fluoreszenz} Vergleich der Anregungs- und Emissionsspektren bei pH 6}
...
\nextgroupplot[standard,title=Emissionsspektrum ph 6 360-370 \si{\nano\meter}]
    \addplotf
   % \addlegendentry{Emissionsspektrum ph 6 360-370 \si{\nano\meter}}
\nextgroupplot[standard,title=Emissionsspektrum ph 6 320-330 \si{\nano\meter}]
    \addplotg
    %    \addlegendentry{Emissionsspektrum ph 6 320-330 \si{\nano\meter}}
\nextgroupplot[standard,title=Anregungsspektrum ph 6 350-340 \si{\nano\meter}]
    \addplotr
    \pgfplotsset{title style={at={(0.5,-0.4)}}}

     %\addlegendentry{Anregungsspektrum ph 6 350-340 \si{\nano\meter}}
    \nextgroupplot[standard,title=Anregungsspektrum ph 6 420-410 \si{\nano\meter}]
    \addplots
        \pgfplotsset{title style={at={(0.5,-0.4)}}}
