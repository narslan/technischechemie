...
local referenz=mess(16691.73)
local trinkwasser=mess(14688.9)
local evian=mess(6632.23)
local jeden=mess(17689.73)
...
\pgfplotsset{
  ...
  x   label style={at={(axis description cs:0.6,-.1)},anchor=south},
...
\begin{tikzpicture}[transform shape]
  ...
  \begin{axis}[standard,xlabel=Konzentration (mg/L),ylabel=Messsignal]
    ...
    \addlegendentry{Messwerte}
      \addlegendentry{$y = 10172x + 616$}
    \addplot[white,thick,domain=0:2,draw=none]{x*0};
    \addlegendentry{$R^2 = 0.997$}
    \addplot[violet,ultra thick,domain=0:5] {-820*x^2+12155*x+27 };
    \addlegendentry{$-820x^2+12155x+27$}
      \addplot[white,thick,domain=0:2,draw=none]{x*0};
